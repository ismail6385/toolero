...
export const metadata: Metadata = {
    title: 'Herramientas Financieras - Calculadoras de Préstamos e Inversión | Toolero.es',
    description: 'Calculadoras financieras gratuitas. Calcula préstamos, hipotecas, interés compuesto, IVA y ahorros. Toma mejores decisiones económicas.',
};

export default function FinanceToolsPage() {
    const category = toolsData.find(c => c.slug === 'finanzas');
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
                    ...
                    <nav className="mb-8 text-sm" aria-label="Breadcrumb">
                        <ol className="flex items-center justify-center space-x-2 text-text/60">
                            <li><Link href="/" className="hover:text-yellow-600 transition-colors">Inicio</Link></li>
                            <li><FontAwesomeIcon icon={faArrowRight} className="text-xs mx-2" /></li>
                            <li><Link href="/categorias" className="hover:text-yellow-600 transition-colors">Categorías</Link></li>
                            <li><FontAwesomeIcon icon={faArrowRight} className="text-xs mx-2" /></li>
                            <li>
                    ...
                    <div className="text-center mb-12">
                        ...
                        <h1 className="text-4xl md:text-6xl font-semibold text-text tracking-tight mb-6">
                            Herramientas <span className="text-yellow-600">Financieras</span>
                        </h1>
                        <p className="mt-4 text-lg md:text-xl text-text/60 max-w-3xl mx-auto leading-relaxed">
                            {category.description} Planifica tu futuro económico con precisión.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4 max-w-2xl mx-auto">
                        ...
                        <div className="bg-background rounded-xl p-4 text-center border border-gray-100 hidden md:block">
                            <div className="text-2xl font-bold text-yellow-600 mb-1">Preciso</div>
                            <div className="text-xs text-text/60 font-semibold">Resultados</div>
                        </div>
                        <div className="bg-background rounded-xl p-4 text-center border border-gray-100">
