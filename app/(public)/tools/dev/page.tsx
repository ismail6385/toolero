...
export default function DevToolsPage() {
    const category = toolsData.find(c => c.slug === 'dev');
    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            <section className="relative w-full overflow-hidden bg-surface pb-16 pt-24 lg:pt-32">
                ...
                <div className="absolute top-0 -right-20 w-96 h-96 bg-purple-500/10 rounded-full blur-3xl mix-blend-multiply opacity-50" />
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
                    ...
                    <div className="text-center mb-12">
                        ...
                        <h1 className="text-4xl md:text-6xl font-semibold text-text tracking-tight mb-6">
                            Herramientas para <span className="text-indigo-600">Desarrolladores</span>
                        </h1>
                        <p className="mt-4 text-lg md:text-xl text-text/60 max-w-3xl mx-auto leading-relaxed">
                            {category.description} JSON, CSS, Textos de prueba y más.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-3 md:grid-cols-3 gap-4 max-w-2xl mx-auto">
                        ...
                        <div className="bg-background rounded-xl p-4 text-center border border-gray-100">
                            ...
                            <div className="text-xs text-text/60 font-semibold">Client-Side</div>
                        </div>
                        <div className="bg-background rounded-xl p-4 text-center border border-gray-100">
                            <div className="text-2xl font-bold text-indigo-600 mb-1">0ms</div>
                            <div className="text-xs text-text/60 font-semibold">Latencia</div>
                        </div>
                    </div>
                </div>
            </section>
