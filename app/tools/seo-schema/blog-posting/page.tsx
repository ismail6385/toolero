    ...
    return (
        <div className="max-w-6xl mx-auto px-4 py-12">
            <div className="mb-8 text-center">
                ...
                <h1 className="text-3xl md:text-4xl font-semibold text-text mb-2">Schema BlogPosting</h1>
                <p className="text-text/60 max-w-2xl mx-auto">
                    Genera Schema.org para posts de blog. Mejora la visibilidad en Google y rich snippets.
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="bg-surface rounded-xl shadow-md border border-gray-200 p-6">
                    ...
                    <div className="space-y-4">
                        <div>
                            <label className="block text-sm font-semibold text-text mb-2">Título del Post *</label>
                            <input type="text" name="headline" value={formData.headline} onChange={handleChange} className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-primary focus:border-primary transition-colors" placeholder="Título del post" />
                        </div>
                        <div>
                            <label className="block text-sm font-semibold text-text mb-2">Descripción</label>
                            <textarea name="description" value={formData.description} onChange={handleChange} rows={3} className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-primary focus:border-primary transition-colors resize-none" placeholder="Resumen del post..." />
                        </div>
                        <div>
                        ...
                        <div className="pt-4 border-t border-gray-200">
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <input type="text" name="publisherName" value={formData.publisherName} onChange={handleChange} className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-primary focus:border-primary transition-colors" placeholder="Nombre del blog" />
                                </div>
                                <div>
