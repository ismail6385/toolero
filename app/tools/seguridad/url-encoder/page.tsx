            ...
            <div className="bg-surface rounded-xl shadow-md border border-gray-200 p-6 mb-6">
                <div className="flex gap-3 mb-6">
                    <button
                        ...
                        className={`flex-1 px-4 py-3 rounded-xl font-semibold transition-colors ${mode === 'encode'
                    ...
                    <button
                        ...
                        className={`flex-1 px-4 py-3 rounded-xl font-semibold transition-colors ${mode === 'decode'
                                ? 'bg-primary text-white shadow-md'
                                : 'bg-background text-text border border-gray-200 hover:border-primary'
                            }`}
                    >
