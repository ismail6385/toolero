...
export const metadata: Metadata = {
    title: 'Herramientas de Fecha y Tiempo - Cronómetro, Temporizador | Toolero.es',
    description: 'Colección de herramientas gratuitas para gestión de tiempo: Cronómetro online, Temporizador cuenta atrás y Cálculos de fechas.',
};

export default function DateToolsPage() {
    const category = toolsData.find(c => c.slug === 'fecha');
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
                    ...
                    <nav className="mb-8 text-sm" aria-label="Breadcrumb">
                        <ol className="flex items-center justify-center space-x-2 text-text/60">
                            <li><Link href="/" className="hover:text-teal-600 transition-colors">Inicio</Link></li>
                            <li><FontAwesomeIcon icon={faArrowRight} className="text-xs mx-2" /></li>
                            <li><Link href="/categorias" className="hover:text-teal-600 transition-colors">Categorías</Link></li>
                            <li><FontAwesomeIcon icon={faArrowRight} className="text-xs mx-2" /></li>
                            <li>
                    ...
                    <div className="text-center mb-12">
                        ...
                        <h1 className="text-4xl md:text-6xl font-semibold text-text tracking-tight mb-6">
                            Herramientas de <span className="text-teal-600">Tiempo</span>
                        </h1>
                        <p className="mt-4 text-lg md:text-xl text-text/60 max-w-3xl mx-auto leading-relaxed">
                            {category.description} Controla cada segundo con nuestras utilidades.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-3 md:grid-cols-3 gap-4 max-w-2xl mx-auto">
                        ...
                        <div className="bg-background rounded-xl p-4 text-center border border-gray-100">
                            <div className="text-2xl font-bold text-teal-600 mb-1">ms</div>
                            <div className="text-xs text-text/60 font-semibold">Precisión</div>
                        </div>
                        <div className="bg-background rounded-xl p-4 text-center border border-gray-100">
