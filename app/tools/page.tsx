...
export const metadata: Metadata = {
  ...
  description: 'Más de 50 herramientas gratuitas: contador de palabras, imágenes, SEO, contraseñas y más. Sin registro y 100% gratis.',
  keywords: [
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
            ...
            <div className="text-center">
              ...
              <h1 className="text-4xl md:text-6xl font-semibold text-text tracking-tight mb-6">
                Catálogo de <span className="text-primary">Herramientas Gratuitas</span>
              </h1>
