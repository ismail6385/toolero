    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            <section className="relative w-full overflow-hidden bg-surface pb-16 pt-24 lg:pt-32">
                <div className="absolute -top-24 -left-20 w-96 h-96 bg-blue-500/10 rounded-full blur-3xl mix-blend-multiply opacity-50" />
                <div className="absolute top-0 -right-20 w-96 h-96 bg-blue-300/10 rounded-full blur-3xl mix-blend-multiply opacity-50" />
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
                    ...
                    <nav className="mb-8 text-sm" aria-label="Breadcrumb">
                        <ol className="flex items-center justify-center space-x-2 text-text/60">
                            ...
                            <li><Link href="/categorias" className="hover:text-blue-500 transition-colors">Categorías</Link></li>
                            <li><FontAwesomeIcon icon={faArrowRight} className="text-xs mx-2" /></li>
                            <li>
                                <span className="text-blue-500 font-semibold" aria-current="page">
                                    {category.name}
                                </span>
                            </li>
                        </ol>
                    ...
                    <div className="text-center mb-12">
                        <div className="inline-flex items-center px-3 py-1 rounded-full border border-blue-500/20 bg-blue-500/5 text-blue-600 text-xs font-semibold uppercase tracking-wide mb-6">
                            <FontAwesomeIcon icon={category.icon} className="mr-2" />
                            {category.name}
                        </div>
                        <h1 className="text-4xl md:text-6xl font-semibold text-text tracking-tight mb-6">
                            Herramientas de <span className="text-blue-500">Email</span>
                        </h1>
                        <p className="mt-4 text-lg md:text-xl text-text/60 max-w-3xl mx-auto leading-relaxed">
                            {category.description} Genera firmas, valida correos y más.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-3 md:grid-cols-3 gap-4 max-w-2xl mx-auto">
                        <div className="bg-background rounded-xl p-4 text-center border border-gray-100">
                            <div className="text-2xl font-bold text-blue-500 mb-1">{category.tools.length}</div>
                        ...
                        <div className="bg-background rounded-xl p-4 text-center border border-gray-100">
                            ...
                            <div className="text-xs text-text/60 font-semibold">Online</div>
                        </div>
                    </div>
                </div>
            </section>
